...
export const diagnosticNames = [
  ...
  'pods_consumption_queue_failed',
  'pods_engagement_queue_failed',
  'pods_exposure_queue_failed',
  'pods_first_render',
  'pods_freshness_check_failed',
  ...
  'pods_session_refresh_failed',
  'pods_share_failed',
  'news_history_enqueue_failed',
  'news_history_write_failed',
  'news_engagement_queue_failed',
